# Generated by Django 2.0.3 on 2019-05-24 15:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trash', models.PositiveSmallIntegerField(default=0, null=True)),
                ('activeTalent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='bank.ActiveGearTalent')),
            ],
        ),
        migrations.CreateModel(
            name='GearAttribute',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('filled', models.PositiveSmallIntegerField(default=0, null=True)),
                ('gear', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bank.Gear')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trash', models.PositiveSmallIntegerField(default=0, null=True)),
                ('activeTalent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='bank.ActiveWeaponTalent')),
            ],
        ),
        migrations.CreateModel(
            name='WeaponFamily',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=255)),
                ('best', models.PositiveSmallIntegerField(default=0, null=True)),
